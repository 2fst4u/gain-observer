...
## 2025-05-05 - Avoid Math.hypot in tight loops
...
**Action:** Always prefer `Math.sqrt` with manual squaring for simple 2D or 3D distance calculations in tight rendering or computation loops, like when processing vertex geometries or complex numbers.
